...
var (
	...
	metrics    = map[string][]string{ // {"metric_name", "metric_help", "metric_label", "metric_type", "metric_regexp", {"label1", "label2"}} - TODO: merge metrics, add metric type and regexp
		...
		"eth_out":                   {"prusa_eth_out", "Ethernet output"},
		"eth_in":                    {"prusa_eth_in", "Ethernet input"},
		"buddy_t":                   {"prusa_buddy_time_us", "Buddy temperature in miliseconds"},
		"puppy_t":                   {"prusa_puppy_time_us", "Puppy temperature in miliseconds"},
		"sync_rt":                   {"prusa_sync_roundtrip_us", "Sync roundtrip in miliseconds"},
		"puppy_off":                 {"prusa_puppy_offset_us", "Puppy offset in us"},
		"puppy_drift":               {"prusa_puppy_drift_ppb", "Puppy drift"},
		"puppy_aoff":                {"prusa_puppy_average_offset_us", "Puppy aoff"},
		"puppy_adrif":               {"prusa_puppy_average_drift_ppb", "Puppy adrift"},
		"fw_version":                {"prusa_info", "Info about the printer itself"},
		"buddy_revision":            {"prusa_info", "Info about the printer itself"},
		"buddy_bom":                 {"prusa_info", "Info about the printer itself"},
		"filament":                  {"prusa_filament", "Loaded filament"},
		"stack":                     {"prusa_stack", "hread stack usage"},
		"runtime":                   {"prusa_runtime", "Thread runtime usage"},
		"is_printing":               {"prusa_is_printing", "Returns information about if pritner is printing 1 - printing, 0 - not printing"},
		"active_extruder":           {"prusa_active_extruder", "Active extruder - used with toolchangers"},
		"temp_hbr":                  {"prusa_temp_hbr", "Heatbreak temperature"},
		"temp_brd":                  {"prusa_temp_brd", "Board temperature"},
		"temp_chamber":              {"prusa_temp_chamber", "Chamber temperature"},
		"temp_mcu":                  {"prusa_temp_mcu", "MCU temperature"},
		"temp_sandwich":             {"prusa_temp_sandwich", "Sandwich temperature"},
		"temp_splitter":             {"prusa_temp_splitter", "Splitter temperature"},
		"temp_bed":                  {"prusa_temp_bed", "Bed temperature"},
		"ttemp_bed":                 {"prusa_target_temp_bed", "Target bed temperature"},
		"temp_noz":                  {"prusa_temp_noz", "Nozzle temperature"},
		"ttemp_noz":                 {"prusa_target_temp_noz", "Target nozzle temperature"},
	}
)
