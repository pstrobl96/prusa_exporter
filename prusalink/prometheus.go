...
func NewCollector(config config.Config) *Collector {
	...
	return &Collector{
		...
		printerCameras:            prometheus.NewDesc("prusa_camera_info", "Return information about cameras", []string{"printer_address", "printer_model", "printer_name", "printer_job_name", "printer_job_path", "camera_id", "camera_name", "camera_resolution"}, nil),
		...
		pritnerUVTemp:             prometheus.NewDesc("prusa_ultraviolet_temperature_celsius", "Status of the printer uv temp", defaultLabels, nil),
